...
This work was done to convert the Madry[Madry adversarial robust model](https://github.com/MadryLab/mnist_challenge) to analyse it with the [Adversarial Decomposition](https://github.com/david-schu/AdversarialDecomposition/) method.
